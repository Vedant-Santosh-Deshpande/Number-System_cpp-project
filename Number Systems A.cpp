...
public:
    ...
    void BinToDeci()
    {
        ...
        do
        {
            ...
            cout << endl;
            cout << " Do You Want To Continue With This Number System ? (yes/no) : ";
            cin >> input;
        } while (input == "yes");
        cout << endl;
        cout << "               * Thank You ,You Are Done With This Conversion.*            " << endl;
        cout << endl;
    }
...
int main()
{
    ...
    do
    {
        ...
        cout << "Do You Want To Run This Code Again ? (yes/no) : ";
        cin >> input;
    } while (input == "yes");
    cout << endl;
